  ...
  fetch(queryString, {
    ...
    .then(function (data) {
      ...
      if (checkData.Response === "False") {
        ...
        $("#modal").modal({ onCloseEnd: function () { $("#find-movie").val(""); } });
...
// Fetch the data and call the 4th search
  ...
  for (let i = 0; i < tmdbData3.length; i++) {
    if (
      ...
      $(".video-container").append(
        '<iframe id="trailer" width="853" height="480" allowfullscreen frameborder="0" src="https://www.youtube.com/embed/' + tmdbData3[i].key + '?autoplay=1&origin=https%3A%2F%2Fwww.themoviedb.org&hl=en&modestbranding=1&fs=1&autohide=1"></"iframe>'
      );
      break;
    }
  }
